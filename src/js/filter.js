...
let buttonFilterPizza = document.querySelector ('.products__products-filter');
let btnCloseFilterPizza = document.querySelector ('.filter-popup__off-btn');

function activePizza() {
    let fiterPizza = document.querySelector ('.filter-popup');
    fiterPizza.classList.add('_active');
}

function closeFilterPizza() {
let fiterPizza = document.querySelector('.filter-popup._active');
fiterPizza.classList.remove('_active');
}
buttonFilterPizza.addEventListener ('click', activePizza);
btnCloseFilterPizza.addEventListener('click', closeFilterPizza);
...
buttonFilterRoll.addEventListener ('click', activeRoll);
